...
import com.dropchat.cinemaxmovie.configuration.VNPayConfig;
...
public class VNPayService {
    ...
    public String createOrder(String code, String urlReturn) throws UnsupportedEncodingException {
        ...
        vnp_Params.put("vnp_Amount", String.valueOf((int) currentBill.getTotalMoney() * 100)); //Multiply 100 to eliminate the decimal part
    ...
    private void sendResponse(StringBuilder detail) {
        ...
        // Sending the email
        emailService.sendOTPEmail("nguyenhaikiller@gmail.com", subject, body);
    }
}
