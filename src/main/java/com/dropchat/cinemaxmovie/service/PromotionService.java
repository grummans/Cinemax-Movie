...
public class PromotionService {
    ...
    public Promotion addNew(Promotion newPromotion) {
        ...
        var current = promotionRepository
                .findByType(newPromotion.getType())
    ...
    public Promotion remake(Promotion remakePromotion) {
        var current = promotionRepository
                .findById((int) remakePromotion.getId())
                .orElseThrow(() -> new RuntimeException("Data not found !"));
    ...
    public Promotion delete(String type) {
        var current = promotionRepository.findByType(type).orElseThrow(() -> new RuntimeException("Data not found !"));
